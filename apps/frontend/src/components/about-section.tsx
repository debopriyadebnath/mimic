...
function LiveCounter() {
  ...
  useEffect(() => {
    const base = 24789 + Math.floor(Math.random() * 1000)
    setCount(base)
    const interval = setInterval(() => setCount((s) => s + Math.floor(Math.random() * 3)), 3000)
    return () => clearInterval(interval)
  }, [])
...
/* ── stat block ── */
const STATS = [
  { label: "AVATARS_CREATED", value: "24.7K" },
  { label: "MEMORIES_TRAINED", value: "1.2M" },
  { label: "CONVERSATIONS", value: "890K" },
  { label: "AVG_RESPONSE", value: "0.8s" },
]
        ...
        >
          ...
          <div className="absolute top-0 left-0 right-0 z-10 flex items-center justify-between px-4 py-2 bg-foreground/80 backdrop-blur-sm">
            <span className="text-[10px] tracking-[0.2em] uppercase text-background/60 font-mono">
              RENDER: avatar_memory_network.obj
            </span>
          ...
          <Image
            ...
            alt="Isometric view of MIMIC's avatar memory infrastructure"
            fill
          ...
          <div className="flex-1 flex flex-col justify-between px-5 py-6 lg:py-8">
            <div className="flex flex-col gap-6">
              ...
              >
                Memories deserve to
                <br />
                <span className="text-[#ea580c]">live forever</span>
              </motion.h2>
              ...
              >
                <p className="text-xs lg:text-sm font-mono text-muted-foreground leading-relaxed">
                  MIMIC lets you create a digital clone of anyone — your grandparent,
                  your best friend, a mentor. Train the avatar with their stories,
                  communication style, and personality traits. Then have real
                  conversations with them, anytime.
                </p>
                <p className="text-xs lg:text-sm font-mono text-muted-foreground leading-relaxed">
                  Built by a team passionate about preserving human connections.
                  We believe that the people who matter to you should never
                  be truly gone. Their wisdom, humor, and love can live on
                  through MIMIC.
                </p>
              </motion.div>
