...
const TIERS: Tier[] = [
  ...
  },
  {
    ...
    period: "/ month",
    tag: "MOST POPULAR",
    description: "Unlimited clones with voice, memory, and full personality.",
    features: [
      { text: "Unlimited avatar clones", included: true },
      { text: "Unlimited memory entries", included: true },
      { text: "Voice + text chat", included: true },
      { text: "Advanced personality AI", included: true },
  ...
  },
  {
    ...
    period: "",
    tag: null,
    description: "For organizations preserving institutional knowledge.",
    features: [
...
export function PricingSection() {
  return (
    <section className="w-full px-6 py-20 lg:px-12">
      ...
      >
        <span className="text-[10px] tracking-[0.2em] uppercase text-muted-foreground font-mono">
          {"* All plans billed monthly. Cancel anytime. Your clones are yours forever."}
        </span>
        <div className="flex-1 border-t border-border" />
      </motion.div>
    </section>
